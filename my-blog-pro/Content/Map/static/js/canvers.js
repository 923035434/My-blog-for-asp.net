...
function  toucheTimeStar()
{
    var i =0;
    toucheTime = setInterval(function(){
        i++;
        if(i>3)
        {
            isBlowing = true;
...
function  toucheTimeEnd()
{
    clearInterval(toucheTime);
    isBlowing = false;
}
...
function createFloor(){
    floor = new THREE.Mesh(new THREE.PlaneBufferGeometry(1000,500), new THREE.MeshBasicMaterial({color: 0xF2F3F7}));//0xd9d9dc
